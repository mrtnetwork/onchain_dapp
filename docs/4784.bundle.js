"use strict";
(self["webpackChunkOnChain_DAPP_Examples"] = self["webpackChunkOnChain_DAPP_Examples"] || []).push([[4784],{
...
/* harmony default export */ const wui_wallet_switch_styles = ((0,lit/* css */.AH) `
  button {
    display: flex;
    align-items: center;
...
let WuiWalletSwitch = class WuiWalletSwitch extends lit/* LitElement */.WF {
    ...
    rightImageTemplate() {
        return (0,lit/* html */.qy) `<wui-icon name="chevronBottom" size="xs" color="fg-200"></wui-icon>`;
    }
};
...
const w3m_profile_wallets_view_TABS_PADDING = 16;
...
let W3mProfileWalletsView = class W3mProfileWalletsView extends lit/* LitElement */.WF {
    constructor() {
        ...
        this.user = AccountController/* AccountController */.U.state.user;
        this.remoteFeatures = OptionsController/* OptionsController */.H.state.remoteFeatures;
        this.tabWidth = '';
        ...
        this.unsubscribers.push(...[
            ...
            AccountController/* AccountController */.U.subscribeKey('user', val => (this.user = val)),
            OptionsController/* OptionsController */.H.subscribeKey('remoteFeatures', val => (this.remoteFeatures = val))
        ]);
        ...
        if (tabsEl) {
            const handleTabsResize = () => {
                ...
                if (tabCount > 1) {
                    ...
                    const totalTabsPadding = w3m_profile_wallets_view_TABS_PADDING * 2;
...
//# sourceMappingURL=index.js.map
// EXTERNAL MODULE: ./node_modules/@reown/appkit-utils/dist/esm/src/CaipNetworkUtil.js + 22 modules
var CaipNetworkUtil = __webpack_require__(95839);
...
let W3mUnsupportedChainView = class W3mUnsupportedChainView extends lit/* LitElement */.WF {
    ...
    async onDisconnect() {
        try {
            ...
            const connectionsByNamespace = ConnectionController/* ConnectionController */.x.getConnections(namespace);
            const hasConnections = connectionsByNamespace.length > 0;
            const connectorId = ConnectorController/* ConnectorController */.a.state.activeConnectorIds[namespace];
            const isMultiWalletEnabled = this.remoteFeatures?.multiWallet;
            await ConnectionController/* ConnectionController */.x.disconnect(isMultiWalletEnabled ? { id: connectorId, namespace } : {});
            if (hasConnections && isMultiWalletEnabled) {
                RouterController/* RouterController */.I.push('ProfileWallets');
...
//# sourceMappingURL=index.js.map
// EXTERNAL MODULE: ./node_modules/@reown/appkit-controllers/dist/esm/src/utils/SIWXUtil.js + 1 modules
var SIWXUtil = __webpack_require__(90346);
...
//# sourceMappingURL=4784.bundle.js.map