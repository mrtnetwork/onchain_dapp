"use strict";(self.webpackChunkonchain_dapp_example=self.webpackChunkonchain_dapp_example||[]).push([[438],{10438:(a,l,r)=>{r.r(l),r.d(l,{ethereumSvg:()=>s});const s=r(12618).JW`<svg width="13" height="12" viewBox="0 0 13 12" fill="none" xmlns="http://www.w3.org/2000/svg">
