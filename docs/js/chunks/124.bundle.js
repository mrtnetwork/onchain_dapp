"use strict";(self.webpackChunkonchain_dapp_example=self.webpackChunkonchain_dapp_example||[]).push([[124],{12851:(e,t,o)=>{var i=o(12618),a=o(25707),r=(o(2132),o(26109)),s=o(43494);const n=i.AH`
  :host {
    display: inline-flex;
...
`;var c=function(e,t,o,i){var a,r=arguments.length,s=r<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,o):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,o,i);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(s=(r<3?a(s):r>3?a(t,o,s):a(t,o))||s);return r>3&&s&&Object.defineProperty(t,o,s),s};let l=class extends i.WF{constructor(){super(...arguments),this.color="accent-100",this.size="lg"}render(){return this.style.cssText="--local-color: "+("inherit"===this.color?"inherit":`var(--wui-color-${this.color})`),this.dataset.size=this.size,i.qy`<svg viewBox="25 25 50 50">
    ...
    </svg>`}};l.styles=[r.W5,n],c([(0,a.MZ)()],l.prototype,"color",void 0),c([(0,a.MZ)()],l.prototype,"size",void 0),l=c([(0,s.E)("wui-loading-spinner")],l)},80124:(e,t,o)=>{o.r(t),o.d(t,{AppKitModal:()=>re,W3mModal:()=>ae,W3mModalBase:()=>ie});var i=o(12618),a=o(25707),r=o(60031),s=o(75910),n=o(24376),c=o(42733),l=o(96396),d=o(6056),p=o(36010),h=o(88249),u=o(31211),w=o(78508),m=o(90346);const g={isUnsupportedChainView:()=>"UnsupportedChain"===w.I.state.view||"SwitchNetwork"===w.I.state.view&&w.I.state.history.includes("UnsupportedChain"),async safeClose(){this.isUnsupportedChainView()||await m.U.isSIWXCloseDisabled()?l.W.shake():("DataCapture"!==w.I.state.view&&"DataCaptureOtpConfirm"!==w.I.state.view||u.x.disconnect(),l.W.close())}};var b=o(68996),f=o(21871),v=o(26742),y=o(80171),k=o(70148),x=o(26109),C=o(43494);const W=i.AH`
  :host {
    display: block;
...
`;var _=function(e,t,o,i){var a,r=arguments.length,s=r<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,o):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,o,i);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(s=(r<3?a(s):r>3?a(t,o,s):a(t,o))||s);return r>3&&s&&Object.defineProperty(t,o,s),s};let V=class extends i.WF{constructor(){super(...arguments),this.backgroundColor="accent-100",this.iconColor="accent-100",this.icon="checkmark",this.message="",this.loading=!1,this.iconType="default"}render(){return i.qy`
      ${this.templateIcon()}
    ...
    `}templateIcon(){return this.loading?i.qy`<wui-loading-spinner size="md" color="accent-100"></wui-loading-spinner>`:"default"===this.iconType?i.qy`<wui-icon size="xl" color=${this.iconColor} name=${this.icon}></wui-icon>`:i.qy`<wui-icon-box
      ...
      icon=${this.icon}
      background="opaque"
    ></wui-icon-box>`}};V.styles=[x.W5,Y],_([(0,a.MZ)()],V.prototype,"backgroundColor",void 0),_([(0,a.MZ)()],V.prototype,"iconColor",void 0),_([(0,a.MZ)()],V.prototype,"icon",void 0),_([(0,a.MZ)()],V.prototype,"message",void 0),_([(0,a.MZ)()],V.prototype,"loading",void 0),_([(0,a.MZ)()],V.prototype,"iconType",void 0),V=_([(0,C.E)("wui-snackbar")],V);const X=i.AH`
  :host {
    display: block;
    position: absolute;
    opacity: 0;
