"use strict";(self.webpackChunkonchain_dapp_example=self.webpackChunkonchain_dapp_example||[]).push([[4009],{41497:(t,e,i)=>{var r=i(12618),o=i(25707),a=i(43494);const s=r.AH`
  :host {
    display: block;
...
`;var $=function(t,e,i,r){var o,a=arguments.length,s=a<3?e:null===r?r=Object.getOwnPropertyDescriptor(e,i):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(t,e,i,r);else for(var n=t.length-1;n>=0;n--)(o=t[n])&&(s=(a<3?o(s):a>3?o(e,i,s):o(e,i))||s);return a>3&&s&&Object.defineProperty(e,i,s),s};let k=class extends o.WF{constructor(){super(...arguments),this.type="approve",this.onlyDirectionIcon=!1,this.images=[],this.price=[],this.amount=[],this.symbol=[]}render(){return o.qy`
      <wui-flex>
        <wui-transaction-visual
          .status=${this.status}
    ...
    `}templateDescription(){const t=this.descriptions?.[0];return t?o.qy`
        ...
        `:null}};k.styles=[y.W5,b],$([(0,a.MZ)()],k.prototype,"type",void 0),$([(0,a.MZ)({type:Array})],k.prototype,"descriptions",void 0),$([(0,a.MZ)()],k.prototype,"date",void 0),$([(0,a.MZ)({type:Boolean})],k.prototype,"onlyDirectionIcon",void 0),$([(0,a.MZ)()],k.prototype,"status",void 0),$([(0,a.MZ)()],k.prototype,"direction",void 0),$([(0,a.MZ)({type:Array})],k.prototype,"images",void 0),$([(0,a.MZ)({type:Array})],k.prototype,"price",void 0),$([(0,a.MZ)({type:Array})],k.prototype,"amount",void 0),$([(0,a.MZ)({type:Array})],k.prototype,"symbol",void 0),k=$([(0,x.E)("wui-transaction-list-item")],k),i(41497);const T=o.AH`
  :host > wui-flex:first-child {
    column-gap: var(--wui-spacing-s);
