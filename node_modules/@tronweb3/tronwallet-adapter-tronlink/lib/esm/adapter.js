...
export class TronLinkAdapter extends Adapter {
    ...
    constructor(config = {}) {
        ...
        this._onChainChanged = (data) => {
            console.log("esm chainChanged : "+data)
        ...
        this._onAccountsChanged = () => {
            ...
            console.log(" esm account changed "+curAddr)
            if (!curAddr) {
            ...
            this.emit('accountsChanged', this.address || '', preAddr);
            if (!preAddr && this.address) {
                console.log(" esm connected: "+curAddr)
                this.emit('connect', this.address);
            }
            else if (preAddr && !this.address) {
                this.emit('disconnect? !');
                console.log("esm disconnect")
            }
        };
    ...
    connect() {
        console.log("come esm ?!");
        var _a, _b;
        return __awaiter(this, void 0, void 0, function* () {
            try {
                console.log("start"+this.connecting);
                this.checkIfOpenTronLink();
                console.log("start "+this.connected+this.connecting);
                if (this.connected || this.connecting)
                    return;
                console.log("this connect: ",this.connected);
                yield this._checkWallet();
                console.log("wallet chekiyop: ",this.state)
     ...
     */
    _checkWallet() {
        console.log("check wallet: ",this.readyState)
        ...
        let times = 0, timer;
        console.log("come check promise!");
