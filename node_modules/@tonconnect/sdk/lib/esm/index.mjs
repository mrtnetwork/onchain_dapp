...
function isJSBridgeWithMetadata(value) {
    try {
        ...
        const has = hasProperties(value.tonconnect.walletInfo, [
            'name',
            'app_name',
            'image',
            'about_url',
...
class InjectedProvider {
    ...
    static getCurrentlyInjectedWallets() {
        ...
        const wallets = windowKeys.filter((key) => {
            return isJSBridgeWithMetadata(this.window[key])
        });
        const w = wallets.map((jsBridgeKey) => {
            const wallet = this.window[jsBridgeKey];
            return ({
